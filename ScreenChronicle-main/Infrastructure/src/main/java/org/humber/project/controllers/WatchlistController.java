...
public class WatchlistController {
    ...
    @PostMapping("/delete/{movie_id}")
    public ResponseEntity<Void> deleteFromWatchlist(@PathVariable Long movie_id, Principal principal) {
        watchlistService.deleteFromWatchlist(movie_id);
